...
//            Arrays.copyOf(SECRET_KEY.getBytes(StandardCharsets.UTF_8), 32)
//    );

//    private static final SecretKey JWT_SECRET_KEY = Keys.secretKeyFor(SignatureAlgorithm.HS512);

    private static final SecretKey JWT_SECRET_KEY = Keys.hmacShaKeyFor(generateHS512().getBytes());

    public static String generateHS512() {
    ...
    public static String generateJwtToken(UserDto userDto) {
        ...
        JwtBuilder builder = Jwts.builder()
                ...
                .signWith(JWT_SECRET_KEY, SignatureAlgorithm.HS512)     // Signature 구성
    ...
    private static Key createSignature() {
        byte[] apiKeySecretBytes = DatatypeConverter.parseBase64Binary(JWT_SECRET_KEY.toString());
