		...
		<div style={{ width: '100%', textAlign: 'center' }}>
			...
			<div
				...
				<div style={{ width: '100%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
					<label>
						<div style={{marginBottom: 10}}>아이디 </div>
				...
				<div style={{ flexDirection: 'row', padding: 20 }}>
					<label>
					<div style={{marginBottom: 10}}>비밀번호 </div>
						<input type='password' onChange={(e) => setUserInfo({ ...userInfo, userPw: e.target.value })} />
					</label>
				</div>

				<div style={{ padding: 20 }}>
					<button type='button' style={{ width: 150, height: 50, fontWeight: 700 }} onClick={loginHandler.login}>
						로그인
					</button>
				</div>
			</div>
