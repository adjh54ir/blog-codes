    ...
    public void headerSendMessage(MessageDto messageDto) {
        try {
            ...
            MessageDto messageDto1 = MessageDto
                    ...
                    .messageByte(objectToJSON.getBytes())
                    .build();

            // 1. 전송하려는 객체를 문자열로 변환합니다.
            ObjectMapper objectMapper2 = new ObjectMapper();
            String objectToJSON2 = objectMapper.writeValueAsString(messageDto1);

            rabbitTemplate.convertAndSend("exchange.headers", "", objectToJSON2);
        } catch (JsonProcessingException jpe) {
            System.out.println("파싱 오류 발생");
        }
    }
