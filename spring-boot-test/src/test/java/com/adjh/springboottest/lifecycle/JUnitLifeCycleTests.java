package com.adjh.springboottest.lifecycle;
...
public class JUnitLifeCycleTests {
    ...
    /**
     * 각 테스트 '메소드 실행 전'에 실행되는 메소드를 정의하는 어노테이션
     */
    @BeforeEach
    void setUp() {
    ...
    /**
     * 각 테스트 '메소드 실행 후'에 실행되는 메소드를 정의하는 어노테이션
     */
    @AfterEach
    void cleanUp() {
    ...
    /**
     * 클래스 내의 '모든 테스트 메서드 실행 전'에 한 번 호출되는 메서드
     */
    @BeforeAll
    ...
    /**
     * 클래스 내의 '모든 테스트 메서드 실행 후'에 한 번 호출되는 메서드
     */
    @AfterAll
